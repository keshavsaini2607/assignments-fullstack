...
https://www.loom.com/share/bbfe23e0b53a499eb141a26947b66d7c?sid=b66b5528-d495-4b03-83f0-de12fe07448a
...
1. **Clone the repository**:
  ...
  ```bash
   git clone https://github.com/keshavsaini2607/assignments-fullstack.git
  ```
2. **Setup Frontend:**
  ```bash
   cd assignments-fullstack
   git checkout keshav-interview-generator
  ```
